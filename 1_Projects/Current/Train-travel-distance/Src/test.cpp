...
int main()
{
    ...
    while (true)
    {
        ...
        points.push_back(cv::Point(max_X * (3.5 / 5.0), max_Y * (1.2 / 5.0))); // RD
        points.push_back(cv::Point(max_X * (3.6 / 5.0), max_Y * (0.0 / 5.0))); // RU
        points.push_back(cv::Point(max_X * (2.1 / 5.0), max_Y * (0.0 / 5.0))); // LU
