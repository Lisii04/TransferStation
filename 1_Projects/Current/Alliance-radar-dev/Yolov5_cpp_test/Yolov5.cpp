...
int main()
{
	...
	detector->load_model("/workspaces/TransferStation/1_Projects/Current/Alliance-radar-dev/Yolov5_cpp_test/car_identfy.onnx", 640, 640, 0.25f);

	cv::VideoCapture capture("/workspaces/TransferStation/1_Projects/Current/Alliance-radar-dev/Yolov5_cpp_test/2.mp4");
	cv::Mat frame;
