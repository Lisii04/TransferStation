...
: ${AMENT_CURRENT_PREFIX:="/workspaces/TransferStation/1_Projects/Current/Alliance-radar-dev/car_detect/install/car_detect"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/car_detect/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/car_detect/environment/path.sh"
