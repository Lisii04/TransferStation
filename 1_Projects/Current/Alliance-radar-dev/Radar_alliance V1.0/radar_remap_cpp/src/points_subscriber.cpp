...
public:
    ...
    {
        // [创建订阅]
        command_subscribe_ = this->create_subscription<std_msgs::msg::Float32MultiArray>("car_position", 10, std::bind(&Points_subscriber::command_callback, this, std::placeholders::_1));
    }
